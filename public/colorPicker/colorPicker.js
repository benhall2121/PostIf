...
function colorPickerNamespace(){
	...
	var colorNames = {'aliceblue':'F0F8FF','darkslategray':'2F4F4F','lightsalmon':'FFA07A','palevioletred':'DB7093','antiquewhite':'FAEBD7',
	...
	function showColorPicker(ev, size){
		...
		if(size!='s'){
			...
			cp.baseColor = parseColor(cp.cpInput.style.backgroundColor);
