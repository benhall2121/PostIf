...
jsColorPicker.prototype.createColorPicker = function () {
    ...
    {
        style: 'position:absolute;font-family:tahoma,verdana,sans-serif;font-size:10px;z-index:999;',
        ref: 'ColorPicker'
    }, ['DIV',
    {
        style: 'background-color:#FFF;line-height:2px;width:423px;_width:424px;height:21px;border:1px solid #000;',
        ref: 'hColorPicker'
    }, ['DIV',
    {
        style: 'width:50px;height:21px;border-right:1px solid #FFF;float:left;',
        ref: 'hColorDiv'
    }],
        ['DIV',
        {
        ...
        }, ['IMG',
        {
            ...
            src: imgBase + '/cp_horizontal_picker.png',
            width: 350,
            height: 21,
            onmousemove: function (evt) {
                _this.hColorPickerMouseMove(_this, evt);
            },
            onmousedown: function (evt) {
                _this.hColorPickerMouseDown(_this, evt);
            },
            ref: 'hColorImg'
        }],
            ['IMG',
            {
                ...
                src: imgBase + '/cp_mini_icon.png',
                width: 21,
                height: 21,
                ref: 'hColorIcon',
                onmousedown: function (evt) {
                    _this.showLgColorPicker(_this, evt);
                }
            }]
        ]
    ],
        ['DIV',
        {
            style: 'border:1px solid #000;width:585px;height:350px;position:relative;background-color:#E0DFE3;',
            ref: 'fColorPicker'
        }, ['DIV',
        {
            style: 'position:absolute;top:3px;left:8px;'
        }, 'Select Color:'],
            ['DIV',
            {
               style: 'padding:0; padding-top: 7px; font-family: Tahoma; font-size: 13px;text-align: center; position: absolute; left: 18px; top: 32px; width: 80px; height: 300px; border: 1px solid #808080;border-radius: 15px;',
               ref: 'sliderBorderLabel'
            }, "Show color" ],
            ['IMG',
            {
                src: imgBase + '/cp_color_slider.png',
                width: 23,
                height: 260,
                style: 'cursor:pointer;position:absolute;top:65px;left:49px;z-index:2;',
                ref: 'colorSlider',
                onmousedown: function (evt) {
                    return _this.cpSliderMouseDown(_this, evt);
                },
                onmouseup: function (evt) {
                    return _this.cpSliderMouseUp(_this, evt);
                },
                onmousemove: function (evt) {
                    return _this.cpMouseMove(_this, evt);
                },
                onclick: function (evt) {
                    return _this.cpSliderClick(_this, evt);
                }
            }],
            ['DIV',
               {
                  style: 'position: absolute; left: 39px; top: 44px; width: 80px; height: 300px; border: 0;',
                  ref: 'arrowHolder'
               },
               ['IMG',
               {
                   src: imgBase + '/cp_arrows.gif',
                   width: 41,
                   height: 9,
                   style: 'cursor:pointer;position:absolute;top:0px;left:0px;z-index:2;',
                   ref: 'Arrows',
                   onmousedown: function (evt) {
                       return _this.cpSliderMouseDown(_this, evt);
                   },
            ...
            ['IMG',
            {
                src: imgBase + '/picker_right_arrow.png',
                width: 16,
                height: 39,
                style: 'position:absolute;top:80px;left:108px;',
                galleryimg: 'yes'
            }],            
            ['DIV',
            {
                  style: 'position: absolute; left: 132px; top: 32px; width: 300px; height: 300px; border: 1px solid #808080;border-radius: 15px; font-family: Tahoma; font-size: 13px; text-align: center;padding:0;padding-top:7px;',
                  ref: 'colorHolder'            
            }, 'Select color: click below to select a color'],
            ['IMG',
            {
                src: imgBase + '/cp_lg_background.png',
                width: 260,
                height: 260,
                style: 'position:absolute;top:65px;left:157px;',
                galleryimg: 'no'
            }],
            ['IMG',
            {
                src: imgBase + '/cp_lg_overlay.png',
                width: 256,
                height: 256,
                style: 'cursor:crosshair;position:absolute;top:67px;left:159px;',
                galleryimg: 'no',
                ref: 'fColorImg',
                onmousedown: function (evt) {
                    return _this.cpMouseDown(_this, evt);
                },
                onmouseup: function (evt) {
                    return _this.cpMouseUp(_this, evt);
                },
                onmousemove: function (evt) {
                    return _this.cpMouseMove(_this, evt);
                },
                onclick: function (evt) {
                    return _this.cpMouseClick(_this, evt);
                }
            }],
            ['IMG',
            {
                ...
                width: 16,
                height: 39,
                style: 'position:absolute;top:80px;left:440px;',
                galleryimg: 'yes'
            }],  
            ['DIV',
            {
                  style: 'position: absolute; left: 463px; top: 32px; width: 100px; height: 300px; border: 1px solid #808080;border-radius: 15px; font-family: Tahoma; font-size: 13px; text-align: center;padding:0;padding-top:7px;',
                  ref: 'colorHolder'            
            }],            
            ['IMG',
            {
                src: imgBase + '/cp_cur_color_background.png',
                width: 62,
                height: 70,
                style: 'position:absolute;top:65px;left:483px;'
            }],
            ['DIV',
            {
                style: 'z-index:2;position:absolute;top:67px;left:485px;width:58px;height:33px;',
                ref: 'curColorDiv'
            }],
            ['DIV',
            {
                style: 'z-index:2;cursor:pointer;position:absolute;top:100px;left:485px;width:58px;height:33px;',
                ref: 'OrigColorDiv',
                onclick: function (evt) {
                    _this.resetColor(_this, evt);
                }
            }],
            ['DIV',
            {
                style: 'position:absolute;top:51px;left:494px;'
            }, 'Selected'],            
            ['DIV',
            {
                style: 'position:absolute;top:135px;left:496px;'
            }, 'Current'],
            ['DIV',
            {
                style: 'position:absolute;top:158px;left:477px;'
            }, 'R:'],
            ['DIV',
            {
                style: 'position:absolute;top:183px;left:477px;'
            }, 'G:'],
            ['DIV',
            {
                style: 'position:absolute;top:208px;left:477px;'
            }, 'B:'],
            ['DIV',
            {
                style: 'position:absolute;top:238px;left:477px;'
            }, '#:'],
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:155px;left:490px;width:47px;',
                ref: 'rInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            }],
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:180px;left:490px;width:47px;',
                ref: 'gInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            ...
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:205px;left:490px;width:47px;',
                ref: 'bInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            ...
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:235px;left:490px;width:47px;',
                ref: 'rgbInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            ...
            ['BUTTON',
            {
                style: 'position:absolute;bottom:50px;left:475px;width:77px;',
                ref: 'OK',
                onclick: function (evt) {
                    _this.hColorPickerMouseDown(_this, evt);
                }
            ...
            ['BUTTON',
            {
                style: 'position:absolute;bottom:25px;left:475px;width:77px;',
                ref: 'Cancel',
                onclick: function (evt) {
                    _this.hideColorPicker(_this, evt);
                }
            }, 'Cancel'],
            ['IMG',
            {
                ...
                ref: 'fColorIcon',
                onmousedown: function (evt) {
                    _this.showSmColorPicker(_this, evt);
                }
            }]
        ]
    ]);
...
jsColorPicker.prototype.parseColor = function (text) {
    if (this.colorNames[text.toLowerCase()]) {
        text = this.colorNames[text.toLowerCase()];
    }
...
jsColorPicker.prototype.documentMouseDown = function (caller, ev) {
    ...
    while (target) {
        if (target == caller.cp.ColorPicker) {
            return;
        }
...
jsColorPicker.prototype.setCurrentElement = function (eDiv) {
    var i;
    for (i = 0; i < this.attachedElement.length; i++) {
